<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="Cliente.aspx.cs" Inherits="ProjAula240521.Cliente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <form id="form1" runat="server">
        <article class="kanban-entry grab" id="item1" draggable="true">
            <div class="kanban-entry-inner">
                <div class="kanban-label">
                    <h2><a href="#">Cadastro Cliente</a> <span></span></h2>
                    <p></p>
                </div>
            </div>
        </article>
        ...
        <div class="form-group">
            ...
            <asp:TextBox class="form-control" name="txtCpfCliente" ID="txtCpfCliente"
                runat="server"></asp:TextBox>
        </div>
         <div class="form-group">
        ...
        <div class="form-group">
            ...
            <asp:TextBox class="form-control" name="txtTelefoneCliente" ID="txtTelefoneCliente"
                runat="server"></asp:TextBox>
        </div>
